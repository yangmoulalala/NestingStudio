...
4. Creates `dist/NestingStudio-1.0.0-windows-x64.zip` and its SHA-256 checksum.
...
├─ NestingStudio/
│  └─ NestingStudio.exe
├─ NestingStudio-1.0.0-windows-x64.zip
└─ NestingStudio-1.0.0-windows-x64.zip.sha256
```
